...
// GetRestoreJobs mocks base method
func (m *MockClient) GetRestoreJobs(ctx context.Context, i *models.GetRestoreJobsInput) (*models.GetRestoreJobsResponse, error) {
	ret := m.ctrl.Call(m, "GetRestoreJobs", ctx, i)
	ret0, _ := ret[0].(*models.GetRestoreJobsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetRestoreJobs indicates an expected call of GetRestoreJobs
func (mr *MockClientMockRecorder) GetRestoreJobs(ctx, i interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRestoreJobs", reflect.TypeOf((*MockClient)(nil).GetRestoreJobs), ctx, i)
}
